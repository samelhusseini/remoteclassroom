    ...
    */
    ...
    function interpretUrlAnchors() {
        ...
        if (location.hash.substr(0, 6) === '#open:') {
            ...
            SnapCloud.username = location.hash.substr(7);
        }
    }
...
IDE_Morph.prototype.setProjectName = function (string) {
    ...
    parent.postMessage({action: 'save', name: string}, "*");
};
...
ProjectDialogMorph.prototype.init = function (ide, task) {
    ...
    this.source = ide.source || 'cloud'; // or 'cloud' or 'examples'
            ...
            SnapCloud.callService(
                ...
                function (response) {
                    ...
                    */
                    ...
                    parent.postMessage({action: 'save', name: proj.ProjectName}, "*");
                },
...
ProjectDialogMorph.prototype.saveCloudProject = function () {
    ...
    var name = this.nameField.contents().text.text;
    parent.postMessage({action: 'save', name: name}, "*");
    this.destroy();
};
