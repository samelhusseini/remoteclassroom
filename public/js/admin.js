...
$(document).ready(function () {
    ...
    $('#import-btn').click(function (e) {
        var token = "7~E9NF2dd8P1yiFnDrw6Mppnh6ae8y2RCdPezygcjt1GnGGyC1JjxweZ6fcuRtXxcK";//localStorage.getItem('token')
        $.ajax({
            url: "https://canvas.instructure.com/api/v1/courses/1207667/users",
            type: 'GET',
